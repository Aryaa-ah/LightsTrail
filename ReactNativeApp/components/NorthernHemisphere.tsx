...
export default function NorthernHemisphere() {
  ...
  if (images.length === 0) {
    return (
      <View style={styles.loadingContainer}>
        <Text style={styles.loadingText}>Loading Northern Hemisphere animation...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.wrapper}>
      <Text style={styles.heading}>Northern Hemisphere Aurora Forecast</Text>
